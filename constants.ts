...
export const translations: Translations = {
  tr: {
    ...
    contact: {
      ...
      email: 'atakan.karakus@ornek.com',
    },
    footer: {
  ...
  en: {
    ...
    contact: {
        ...
        email: 'atakan.karakus@example.com',
    },
    footer: {
...
export const projectsData: { [key: string]: Project[] } = {
  tr: [
    {
      title: 'Kernel Derleme Otomasyonu',
